...
import type {ReturnSuccessReturn} from '@altie122/utils/api';

interface Props {
    links?: ReturnSuccessReturn<Doc<'links'>[]>;
}

export function LinkPanel({links}: Props) {
    return (
